...
function seedDefaultProfiles(): StudentProfile[] {
  const defaultStudents: StudentProfile[] = [
    ...
    },
    {
      ...
      stars: 22,
      coins: 80,
      completedExerciseIds: ['vow-1', 'vow-2', 'vow-3', 'cons-1', 'cons-2', 'jly-1', 'jly-2', 'abc-1', 'syl-1', 'syl-2', 'sd-1', 'sd-2', 'sent-1', 'sent-2'],
      answerLogs: [
        { exerciseId: 'vow-1', topicId: 'vowels', subtopic: 'Jelentésmegkülönböztető', isCorrect: true, userAnswer: 'húrok', timestamp: Date.now() - 3600000 },
        { exerciseId: 'jly-1', topicId: 'j-ly', subtopic: 'Madarak nevei', isCorrect: true, userAnswer: 'papagáj', timestamp: Date.now() - 3400000 },
        { exerciseId: 'sd-1', topicId: 'sound-diff', subtopic: '-lj szavak', isCorrect: true, userAnswer: 'éljen', timestamp: Date.now() - 3000000 },
        { exerciseId: 'sent-2', topicId: 'sentences', subtopic: 'Mondatvégi írásjelek', isCorrect: true, userAnswer: '?', timestamp: Date.now() - 2500000 },
      ],
      unlockedBadgeIds: ['first-step', 'five-done', 'ten-done', 'master-vowels'],
      createdAt: Date.now() - 86400000,
      lastActive: Date.now() - 1500000,
    },
    {
      id: 'demo_zoli_3a',
      name: 'Zoli',
      ...
      stars: 16,
      coins: 55,
      completedExerciseIds: ['vow-1', 'vow-2', 'cons-1', 'jly-1', 'abc-1', 'syl-1'],
      answerLogs: [
        { exerciseId: 'vow-1', topicId: 'vowels', subtopic: 'Jelentésmegkülönböztető', isCorrect: true, userAnswer: 'húrok', timestamp: Date.now() - 4000000 },
        { exerciseId: 'sd-6', topicId: 'sound-diff', subtopic: '-dt szavak', isCorrect: false, userAnswer: 'aluttam', timestamp: Date.now() - 3200000 },
      ],
      unlockedBadgeIds: ['first-step', 'five-done'],
      createdAt: Date.now() - 86400000,
      lastActive: Date.now() - 2000000,
    },
    {
      ...
      stars: 19,
      coins: 65,
      completedExerciseIds: ['vow-1', 'vow-2', 'vow-3', 'cons-1', 'cons-2', 'jly-1', 'jly-2', 'abc-1'],
      answerLogs: [
        { exerciseId: 'vow-1', topicId: 'vowels', subtopic: 'Jelentésmegkülönböztető', isCorrect: true, userAnswer: 'húrok', timestamp: Date.now() - 5000000 },
        { exerciseId: 'jly-2', topicId: 'j-ly', subtopic: 'Szó eleji j és ly', isCorrect: true, userAnswer: 'lyuk', timestamp: Date.now() - 4500000 },
      ],
      unlockedBadgeIds: ['first-step', 'five-done', 'ten-done'],
      createdAt: Date.now() - 86400000,
